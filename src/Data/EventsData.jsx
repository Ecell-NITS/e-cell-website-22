...
export const alleventeic = [
  {
    ...
    content:
      "The event that brought all six branches against each other had four very successful modules under it. All four events saw a wide range of participants coming in from each branch.",
  },
  {
    id: 2,
    ...
    content:
      "Filled with a lot of bounces and pounces, the buzzer quiz brought all the quizzers from different departments under one roof : to compete with each other. This event, a battle of two rounds, saw a lot of quiz enthusiasts.",
  },
  {
    id: 3,
    ...
    content:
      "Pitch your innovation allowed the hidden innovators in the participants to come out. The participants pitched their products to the judges using many fun yet informative ways.",
  },
  {
    id: 4,
    ...
    content:
      "The marketing contest was embraced by many who brought in very innovative and fun products, with a well-planned marketing strategy. This event was enjoyed by all judges and participants likewise.",
  },
  {
    id: 5,
    ...
    date: "4th Feb, Startup Centre, NIT Silchar",
    content:
      "The E-Cell version of Shark Tank was the highlight of EIC. Investments having a valuation of 1 crore were also raised during this very successful event.",
  },
];
...
export const alleventsrijan = [
  {
    ...
    content:
      "Srijan 3.0, the biggest flagship event of E-Cell, NIT Silchar was organised in hybrid mode between April 9 to April 13, 2022. The event was a huge success and saw participants from all over the country. ",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: (
      <>
        Taking the line &#34;the ideas of one can be a challenge for others&#34; as their
        motto, this event brought all the competitors together by giving them a space to
        exchange ideas with each other and still get the winning spot.
      </>
    ),
  },
  {
