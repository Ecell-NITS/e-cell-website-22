        ...
        <div className="leftblogcontent">
          ...
          {activeTagFilter ? (
              ...
              {filteredBlogs.length === 0 ? (
                ...
                <p className="msgonblogcnt">
                  {filteredBlogs.length > 1 ? (
                    <>{filteredBlogs.length} blogs found with the tag </>
                  ) : (
                    <>{filteredBlogs.length} blog found with the tag </>
                  )}{" "}
                  &#34;
                  {activeTagFilter}
                </p>
            ...
            <p className="msgonblogcnt">
              ...
              {filteredBlogs.length > 1 ? <> blogs </> : <> blog</>} found on
              the server.
            </p>
          )}
