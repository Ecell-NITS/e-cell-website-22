            ...
            <div className="mainparentblogindicard">
              {Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="indicardblog">
                  <div className="imgholdercontblog skel"></div>
                  <h1
                    className="titlehainlogindi skel"
                    style={{ whiteSpace: "pre-line", height: "2.1rem", width: "90%" }}
                  ></h1>
                  <div className="whowrittenblogsk skel"></div>
                  ...
                  <div className="briefintrohldman skel"></div>
