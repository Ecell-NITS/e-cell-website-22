      ...
      <div className="mainblogstarts">
        <div className="leftblogcontent">
          ...
          {activeTagFilter ? (
            ...
            <p className="msgonblogcnt">
              {filteredBlogs.length} total Provisional blogs found on the server.
            </p>
          )}
                        ...
                        <div className="btnholderprovisi">
                          <div>
                            {publishedBlogIds.includes(blog._id) ? (
                              <button disabled className="kretrhereading" id="pblshbtn">
                                Published
                              </button>
                            ) : (
                              <button
                                ...
                                style={{
                                  opacity: disablepublish ? 0.5 : 1,
                                  cursor: disablepublish ? "not-allowed" : "pointer",
                                }}
