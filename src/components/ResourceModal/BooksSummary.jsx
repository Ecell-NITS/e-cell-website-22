  ...
  return (
    <>
      ...
      <div className="toprecuitcontent fdfdfere">
        <h2>
          When Elon Musk was asked how he learned to build rockets, he gave a simple and
          striking answer: “I read books”. Here are some recommendations to read which are
          on the list of every entrepreneur out there!{" "}
        </h2>
      </div>
