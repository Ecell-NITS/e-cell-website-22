...
const EditProfile = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .put(import.meta.env.VITE_REACT_APP_EDITPROFILE, { name, bio, userimg, facebook, github, instagram, linkedin, newpwd, confirmnewpwd }, {
        headers: {
        ...
        <div className="formcontsignup">
          ...
          <form onSubmit={handleSubmit} className='formsignaccoutn'>
            ...
            <div className="inputdicdignup">
              ...
              <textarea cols="10" rows="5" id="cretaeblogsinpt" type='text'
                value={bio} onChange={handleBioChange}
