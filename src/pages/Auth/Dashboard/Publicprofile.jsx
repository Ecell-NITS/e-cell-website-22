...
const Publicprofile = () => {
    ...
    useEffect(() => {
        const fetchPublicProfile = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_REACT_APP_APIMAIN}/publicprofile/${authoruniqueid}`);
    ...
    useEffect(() => {
        const fetchPublicBlogs = async () => {
            try {
                setFetching(true)
                const response = await axios.get(`${import.meta.env.VITE_REACT_APP_APIMAIN}/publicwrittenblogs/${authoruniqueid}`)
