...
const Login = () => {
    ...
    const handlelogin = (e) => {
        ...
        axios.post(import.meta.env.VITE_REACT_APP_LOGIN,
            { email, password })
            .then(response => {
                ...
                <div className="formcontsignup">
                    ...
                    <form onSubmit={handlelogin} className='formsignaccoutn'>
                        ...
                        <div className="inputdicdignup" id='fogtpwd'>
                            <span  disabled={disablelogin} style={{ cursor: disablelogin ? "not-allowed" : "pointer" }} onClick={handleForgetPwd}>Forgot Password?</span>
                        </div>
