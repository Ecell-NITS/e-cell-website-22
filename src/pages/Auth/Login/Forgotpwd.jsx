...
const Forgotpwd = () => {
    ...
    const handlelogin = (e) => {
        ...
        setDisable(true)
        setSendingotp(true)
        axios.post(`${process.env.REACT_APP_APIMAIN}/forgotpwd`,
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_APIMAIN}/verifyotpresetpwd`, {
                otp, email
            });
    ...
    const handleFinalPwd = async (e) => {
        ...
        try {
            ...
            await axios.put(`${process.env.REACT_APP_APIMAIN}/changingpwd`, { email, newpwd0, confirmnewpwd0 })
                .then(() => {
                    setConfirmnewpwd0("")
                    setNewpwd0("")
