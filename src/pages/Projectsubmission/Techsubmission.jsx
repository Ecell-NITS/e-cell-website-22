...
const Techsubmission = () => {
    ...
    const isFormValid = () => {
        return (
            ...
            email !== "" &&
            mobileno !== "" &&
            scholarId !== "" && project !== "" && techteam !== "" && otp !== ""
        );
    };
    ...
    const sendOTP = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                ...
                `${process.env.REACT_APP_PROJECTSUBMISSION_API}/send-otp`,
                {
                    email,
                }
            );
    ...
    const submitbtn = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_PROJECTSUBMISSION_API}/check-email`, {
                email: email
            });
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_PROJECTSUBMISSION_API}/check-scholarid`, {
                scholarId: scholarId
            });
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_PROJECTSUBMISSION_API}/verify-otp`, {
                otp, email
            });
        ...
        axios
            ...
            .post(`${process.env.REACT_APP_PROJECTSUBMISSION_API}/submitform`, {
    ...
    return (
        <>
            ...
            <div className='recruitingmain'>
                ...
                <div>
                    <button onClick={sendOTP} className='btnotpsend' disabled={stopotp || stopsubmit} style={{ opacity: stopotp || stopsubmit ? 0.5 : 1, cursor: stopotp || stopsubmit ? "not-allowed" : "pointer" }} >Send OTP to Institute email</button>
                </div>
                ...
                <h3 className='common-form-recuit'>Which domain in technical team of ECELL you had applied for?<span className='reqdinput'>*</span></h3>
                ...
                <button onClick={submitbtn} className='submtformrecuit' disabled={stopotp || stopsubmit} style={{ opacity: stopotp || stopsubmit ? 0.5 : 1, cursor: stopotp || stopsubmit ? "not-allowed" : "pointer" }} >
