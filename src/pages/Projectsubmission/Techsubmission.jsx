...
const Techsubmission = () => {
    ...
    const submitbtn = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_REACT_APP_PROJECTSUBMISSION_API}/check-email`, {
                email: email
            });
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_REACT_APP_PROJECTSUBMISSION_API}/check-scholarid`, {
                scholarId: scholarId
            });
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_REACT_APP_PROJECTSUBMISSION_API}/verify-otp`, {
                otp, email
            });
