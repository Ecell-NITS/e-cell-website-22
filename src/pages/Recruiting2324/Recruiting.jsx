  ...
  const createUser = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_RECRUITMENT_CHECKEMAIL,
        {
    ...
    try {
      ...
      setDisablesubmitreg(true);
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_RECRUITMENT_CHECKSCHOLARID,
        {
    ...
    try {
      ...
      setDisablesubmitreg(true);
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_RECRUITMENT_VERIFYOTP,
        {
    ...
    <>
      ...
      <div className="toprecuitcontent">
        <h2>
          ...
          communicators and influencers in the entrepreneurial ecosystem. As a part of our
          team, you will have the opportunity to engage with a diverse audience, promote
          entrepreneurship, and contribute to our vision of fostering innovation and
          creativity.{" "}
        </h2>
      </div>
      ...
      <div className="recruitingmain">
        ...
        <h3 className="common-form-recuit">
          Branch<span className="reqdinput">*</span>
        </h3>
        ...
        <div>
          <button
            ...
            disabled={disableotpsend || disablesubmitreg}
            style={{
              opacity: disableotpsend || disablesubmitreg ? 0.5 : 1,
              cursor: disableotpsend || disablesubmitreg ? "not-allowed" : "pointer",
            }}
          >
        ...
        <h3 className="common-form-recuit">
          Which team you want to apply for? (multiple team selection allowed)
        ...
        <div className="radioinptholder">
          ...
          <label className="radioinpt">
            <input
              type="checkbox"
              name="team"
              value="Collaboration & Outreach"
              checked={team.includes("Collaboration & Outreach")}
              onChange={handleTeamSelection}
            />
          ...
          <label className="radioinpt">
            <input
              ...
              name="team"
              value="Curation"
              checked={team.includes("Curation")}
              onChange={handleTeamSelection}
            />
            Curation
          </label>
          ...
          <label className="radioinpt">
            <input
              ...
              checked={team.includes("Event Management")}
              onChange={handleTeamSelection}
            />
            Event Management
          </label>
          ...
          <label className="radioinpt">
            <input
              ...
              name="team"
              value="Marketing"
              checked={team.includes("Marketing")}
              onChange={handleTeamSelection}
            />
            Marketing
          </label>
          ...
          <label className="radioinpt">
            <input
              ...
              name="team"
              value="Publicity"
              checked={team.includes("Publicity")}
              onChange={handleTeamSelection}
            />
            Publicity
          </label>
        ...
        <h3 className="common-form-recuit">
          Why do you want to join E-Cell?<span className="reqdinput">*</span>
        </h3>
        <textarea
          type="text"
          rows="3"
        ...
        <h3 className="common-form-recuit">
          Prove you&#39;re not a robot<span className="reqdinput">*</span>
        </h3>
        <span className="robottxt">
        ...
        <button
          ...
          disabled={disablesubmitreg || disableotpsend}
          style={{
            opacity: disablesubmitreg || disableotpsend ? 0.5 : 1,
            cursor: disablesubmitreg || disableotpsend ? "not-allowed" : "pointer",
          }}
        >
